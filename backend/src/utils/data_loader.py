...
class DataLoader:
    def __init__(self, final_data_dir: str = None, raw_data_dir: str = None,
        ...
        self.final_data_dir = final_data_dir or paths_config.get('final_data_dir', 'backend/data/final')
        self.raw_data_dir = raw_data_dir or paths_config.get('raw_data_dir', 'backend/data/raw')
